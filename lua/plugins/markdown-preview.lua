return {
  ...
  init = function()
    -- vim.cmd('vim.g.mkdp_filetypes = { "markdown" }')
    -- vim.cmd('vim.g.mkdp_open_to_the_world = 1')
    -- vim.cmd('vim.g.mkdp_auto_start = 0')
    -- vim.cmd('vim.g.mkdp_browser = 'C:/Program Files/Mozilla Firefox/firefox.exe'')
